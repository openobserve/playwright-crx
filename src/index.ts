...
export { classifySelector, buildLocatorBundle, MAX_LOCATOR_CANDIDATES } from './server/recorder/locatorBundle';
...
export { buildSettlePatterns, isSameSite, isCandidateSignal, NetworkRecorder, MAX_SETTLE_PATTERNS } from './server/recorder/networkCapture';
